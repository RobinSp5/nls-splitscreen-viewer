...
**Open the viewer:** https://robinsp5.github.io/nls-splitscreen-viewer/

## Features

- Splitscreens in different layouts: 2x2, 1x4, 4x1 or 1+3 / 1+4 / 1+5 / 1+6 (one big main stream plus several small onboards)
